...
export const ENTRIES: LogEntry[] = [
  {
    id: "2026-07-08-read-only-agents-need-proof",
    ...
    content: `I built a scheduled agent that reads system state, summarizes it, and posts a brief to a chat channel. Read-only by design: it must never write or send. The easy version is a prompt that says "make zero tool calls, never send." That is a promise, not a control.
