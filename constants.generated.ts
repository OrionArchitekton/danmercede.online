...
,
  {
    id: "2026-09-22-when-the-default-matches",
...
,
  {
    id: "2026-09-13-persistent-is-not-a-retry",
...
,
  {
    id: "2026-08-24-strandedness-is-evidence",
    ...
    content: `I found two worktrees holding a finished security fix. Staged, never committed, 23 days
...
,
  {
    id: "2026-08-16-control-shared-contamination",
...
,
  {
    id: "2026-08-14-zero-diffs-valid-outcome",
...
,
  {
    id: "2026-08-13-findings-as-ownership",
...
,
  {
    id: "2026-08-12-empty-envelope-says-success",
...
,
  {
    ...
    content: `Today an agent session died with SIGABRT in the middle of writing its own handoff checkpoint. The draft existed in exactly one place: the session's temp scratchpad, which gets wiped on reboot. Hours of verified state, one power cycle from gone.
...
,
  {
    ...
    content: `Today an adversarial review engine flagged my hardening PR as a breaking change. Factually correct. Strategically wrong.
